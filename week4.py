...
#NAMES: Vanessa Suarez, Malik Hreish 
...
print("the max of 23,89,12,54,92,65,71,13,45 is" ,max(23,89,12,54,92,65,71,13,45))
print("the min of 23,89,12,54,92,65,71,13,45 is" ,min(23,89,12,54,92,65,71,13,45))

# Task 5: Round the number 12.5678 to 2 decimal places.
print("round 12.5678 is",round (12.5678))

# Task 6: Find the absolute value of -45.
print("the absoulute value of -45 is", abs(-45))
...
print("The prices summed up together is" ,sum(prices))
